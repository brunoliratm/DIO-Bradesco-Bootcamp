public class Iniciar {
  public static void main(String[] args) {
    ...
    if (args.length > 0) {
      initialValues = String.join(" ", args);
    } else {
      initialValues = "0,0;4,false 1,0;7,false 2,0;9,true 3,0;5,false 4,0;8,true 5,0;6,true 6,0;2,true 7,0;3,false 8,0;1,false "
          +
    ...
    SudokuGame game = new SudokuGame(initialValues);
    game.play();
  }
}
